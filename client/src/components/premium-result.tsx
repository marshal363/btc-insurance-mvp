...
export const PremiumResult = ({
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="ios-card overflow-hidden bg-gradient-to-br from-primary to-primary-700 text-white">
        <div className="p-6">
          ...
          <div className="mt-6">
            <Button className="ios-button w-full bg-white text-primary hover:bg-white/90 font-semibold text-base h-12">
              {type === "buyer" 
                ? (
